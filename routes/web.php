...
Route::post('/swim-team/usa-meet-schedule/upload', [\App\Http\Controllers\SwimTeam\MeetScheduleController::class, 'uploadUsaCompetitive'])->name('swim-team.usa-meet-schedule.upload')->middleware('auth');
