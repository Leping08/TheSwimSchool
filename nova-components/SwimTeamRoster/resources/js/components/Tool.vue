<template>
    <div>
        <heading class="mb-6">Swim Team Roster</heading>
        ...
        <card class="bg-90 flex flex-col items-center justify-center" style="min-height: 300px">
            ...
            <h1 class="text-grey-darker text-4xl text-90 font-light mb-6">
                We're in a black hole.
            </h1>

            <p class="text-white-50% text-lg">
                You can edit this tool's component at:
                <code class="ml-1 border border-80 text-sm font-mono text-white bg-black rounded px-2 py-1">/nova-tools/SwimTeamRoster/resources/js/components/Tool.vue</code>
            </p>
        </card>

        <card class="flex flex-col mt-2 p-2">

            <div class="">
                <table class="w-full text-left table-collapse">
                    <thead>
                        <tr>
                            <th class="text-sm font-semibold text-grey-darker p-4 bg-grey-lightest">Class</th>
                            <th class="text-sm font-semibold text-grey-darker p-4 bg-grey-lightest">Properties</th>
                        </tr>
                    </thead>
                    <tbody class="align-baseline">
                        <tr>
                            <td class="p-4 border-t border-grey-light font-mono text-xs text-purple-dark whitespace-no-wrap">
                                .table-auto
                            </td>
                            <td class="p-4 border-t border-grey-light font-mono text-xs text-blue-dark whitespace-no-wrap">
                                table-layout: auto;
                            </td>
                        </tr>
                    </tbody>
