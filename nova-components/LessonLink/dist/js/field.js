...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-lesson-link', __webpack_require__(3));
    Vue.component('detail-lesson-link', __webpack_require__(6));
    Vue.component('form-lesson-link', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getLessonLink: function getLessonLink() {
            var _this = this;

            axios.get('/api/lesson-link/' + this.resourceId).then(function (response) {
                console.log(response.data);
                _this.link = response.data + '/' + _this.resourceId;
