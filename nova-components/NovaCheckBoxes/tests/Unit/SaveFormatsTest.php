...
class SaveFormatsTest extends TestCase
{
    ...
    public function test_default_to_save_only_unchecked()
    {
    ...
    public function test_default_save_when_nothing_is_checked()
    {
        $this->zeroIndexedField()->fill((new NovaRequest)->merge([
    ...
    public function test_save_as_string()
    {
    ...
    public function test_save_as_string_when_nothing_is_checked_even_if_save_unchecked_values_is_on()
    {
   ...
   public function test_save_unchecked_values()
   {
