...
{
    public function test_checkbox_field_can_be_serialized()
    {
    ...
    public function test_checkboxes_field_options_as_an_associative_array()
    {
    ...
    public function test_checkboxes_field_options_as_a_value_only_array()
    {
        $field = Checkboxes::make('Hobbies')->options([
            'Sailing',
            'Rock Climbing',
    ...
    public function test_checkboxes_field_can_be_set_to_save_as_string()
    {
    ...
    public function test_checkboxes_field_can_be_set_to_save_unchecked_values()
    {
    ...
    public function test_checkboxes_field_can_be_set_to_display_unchecked_values_on_index()
    {
    ...
    public function test_checkboxes_field_can_be_set_to_display_unchecked_values_on_detail()
    {
    ...
    public function test_checkboxes_field_can_be_set_to_display_options_in_many_columns()
    {
