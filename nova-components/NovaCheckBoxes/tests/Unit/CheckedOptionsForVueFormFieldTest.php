...
class CheckedOptionsForVueFormFieldTest extends TestCase
{
    ...
    public function test_field_value_when_empty()
    {
    ...
    public function test_resolves_field_value_from_array()
    {
    ...
    public function test_resolves_field_value_from_collection()
    {
        $this->assocField()->assertValue(
    ...
    public function test_resolves_field_value_from_nested_json_attribute()
    {
        $this->assocField()->assertValue(
    ...
    public function test_resolves_field_value_from_object()
    {
        $this->assocField()->assertValue(
    ...
    public function test_resolves_field_value_from_string()
    {
        $this->assocField()->assertValue(
    ...
    public function test_resolves_field_value_from_string_when_option_zero_is_checked()
    {
    ...
    public function test_when_previous_options_have_been_removed()
    {
