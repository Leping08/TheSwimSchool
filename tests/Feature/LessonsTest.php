...
class LessonsTest extends TestCase
{
    ...
    {
        $lessonInProgress = factory(\App\Models\Lesson::class)->create([
    ...
    {
        $registrationNotOpenYet = factory(\App\Models\Lesson::class)->create([
    ...
    {
        $lessonFinished = factory(\App\Models\Lesson::class)->create([
    ...
    {
        $registrationOpen = factory(\App\Models\Lesson::class)->create([
    ...
    public function a_user_can_not_see_a_lesson_that_starts_today()
    {
        ...
        $this->assertFalse(\App\Models\Lesson::registrationOpen()->contains($lesson));
    }
