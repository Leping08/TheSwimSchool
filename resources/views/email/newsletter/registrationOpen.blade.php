...
Registration is now open for all of our swim programs starting in January including group swim lessons, private swim lessons, and the Flying Fish and Shark swim club. As a reminder, The Swim School now has an official business phone line and the new number is **{{ config('contact.phone.number') }}**. You can reach us by either calling this number, sending a message through the “Contact Us” section of the website, or sending an email to **info@theswimschoolfl.com**. The previous phone number is no longer in service, so please update our contact details. We are looking forward to seeing you at the pool soon!
@endcomponent
