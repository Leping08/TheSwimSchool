...
<div style="display:flex; justify-content: center; padding: 1em 0em 0em 0em; font-size: x-small; color: #9BA2AB">If you are no longer interested in receiving emails from The Swim School, you can <a href="/unsubscribe/{{{$emailAddress}}}">unsubscribe instantly</a></div>
@endcomponent
