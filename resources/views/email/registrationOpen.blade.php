...
<img alt="" style="margin-bottom: 2em;" src="{{asset('img/lessons/dolphin_free_style.jpg')}}">

@component('mail::panel')
# Registration is Now Open
Registration is now open for our final weekend session of group swim lessons for the 2019 season! If you are currently enrolled and have any questions regarding which level to sign your child up for in the next session, please consult with your instructor.
@endcomponent
