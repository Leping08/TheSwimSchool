...
<img style="margin-bottom: 2em;" src="{{asset('img/lessons/toddler.jpg')}}">

@component('mail::panel')
# Registration is Now Open
Registration is now open for our next weekend sessions of group swim lessons. If you are currently enrolled and have any questions regarding which level to sign your child up for in the next session, please consult with your instructor.
@endcomponent
