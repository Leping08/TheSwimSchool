    ...
    <div class="uk-section-default uk-section-overlap uk-section">
        <div class="uk-container">
            ...
            <dl class="uk-description-list uk-description-list-divider">
                ...
                <dt>Liability:</dt>
                <dd>The enrolled participant and/or the parent/guardian of the participant recognize and
                    understand that swimming is a Physical activity. In such there are risks inherent in the
                    instruction and sport of swimming including but not limited to paralyzing injuries and the
                    possibility of death. The participant hereby agrees to participate in the North River Swim
                    Team, a program of The Swim School, and hereby agrees to indemnify and hold harmless
                    The Swim School, its coaches, teachers, instructors, officers, directors, agents and
                    employees against any liability resulting from any injury that may occur to the participant
                    while participating in the North River Swim Team. The participant also agrees to indemnify
                    The Swim School for any damages incurred arising from any claim, demand, action or
                    cause of action by the participant. The participant and/or parent/guardian authorizes any
                    representative, coaches, teachers, instructors, officers, directors, agents or employees of
                    The Swim School to have the participant treated in any medical emergency during their
                    participation in the swim program. Further, the participant and/or parent/guardian agree to
                    pay all costs associated with medical care and transportation for the participant.</dd>


                <dt>Medical Acknowledgement:</dt>
                <dd>I certify that, to the best of my knowledge and belief, the participant is in good physical condition
                    and has no condition that would impair participation in the North River Swim Team program.
                    Please notify Hilary Koppenhaver of any medical and/or health issues regarding your child that
                    the swim team coaches should be aware of prior to the start of the swim team season. (i.e.
                    allergies, epipen for allergic reaction, asthma, etc.)</dd>

                <dt>Photo and Video Policy:</dt>
                <dd>I am aware that individual and group publicity photos and videos are taken from time to time
                    and in consideration for my child's participation, I hereby grant permission for my or my
                    child's likeness to be used in company publicity and/or advertising.</dd>

                <dt>Facility and Pool Use:</dt>
                <dd>Fitness Center Facility use is for River Wilderness Country Club members only. Swim Team
                    participants may use the locker rooms and pool during scheduled swim team practice times
                    only and must be supervised by an adult when inside the facility. Use of the locker rooms
                    and pool outside of swim team time is for River Wilderness Country Club members only.</dd>

                <dt>Swimmer Registration & Program Payment:</dt>
                <dd>All swimmers must register online following tryouts to reserve their spot on the swim team.
                    Program fee must be paid online in full for the entire swim team season prior to May 1st of
                    the current year. All payments are non refundable. No prorated discounts will be offered for
                    swimmers who tryout and join the swim team after May 1st of the current year. For
                ...
                <dd>The swim team coaches reserve the right to change a swimmer’s swim team group in
                    accordance with their swimming abilities as necessary throughout the duration of the swim
                    season.</dd>

                <dt>Safety:</dt>
                <dd>All children must be accompanied by an adult and directly supervised before and after their
                    swim practices. There are no lifeguards at the facility.</dd>

                <dt>Practice Observation:</dt>
                <dd>In order to foster the best learning environment for each swimmer, the least amount of
                    distraction is required. For swimmers to remain focused and fully attentive to their coaches
                    during swim practices, parents and other family members are permitted on the pool deck
                    but must view swimmers from the designated observation area. We ask that parents refrain
                ...
                <dd>The goal of the North River Swim Team is to foster a positive environment for all involved.
                    We will need the support and involvement of our parents to run an effective program. Just
                    as we will expect the swimmers to practice teamwork, good sportsmanship, and self-control,
                    this will be the same expected conduct for all parents as well. We encourage open
                    communication but ask that parents refrain from interrupting swimmers and coaches during
                    practice times. Coaches will make themselves available for pertinent discussion outside of
                    practice times. As a parent, I understand the North River Swim Team maintains the right to
                    dismiss anyone from involvement with the team with or without cause if it brings discredit or
                    discord to the program.</dd>

                <dt>Disciplinary Procedure:</dt>
                <dd>If a swimmer is disruptive (defined as any behavior which requires the full attention of a staff
                    member, thereby interfering with the functioning of the group) during swim practices or swim
                    meets, the coaches will use the following disciplinary procedure to handle situations:</dd>
