    ...
    <div class="uk-section-default uk-section-overlap uk-section">
        <div class="uk-container">
            ...
            <dl class="uk-description-list uk-description-list-divider">
                ...
                <dd>All swimmers must register online following tryouts to reserve their spot on the swim team. Program fee must be paid online in full for the entire swim team season prior to May 1st of the current year. All payments are non refundable. No prorated discounts will be offered for swimmers who tryout and join the swim team after May 1st of the current year. For swimmers who join the team after May 1st of the current year, the program fee must be paid online in full prior to participating in the first swim team practice.</dd>

                <dt>Equipment:</dt>
                <dd>Goggles and a swim cap are highly recommended for improved vision, comfort and performance. Please supply your child with a pair of goggles and a swim cap for swim team practices. Each child will receive one free team swim cap prior to the first swim meet of each swim team season to use for the purpose of swim meet competitions. If the team swim cap is lost or damaged, a new team swim cap will need to be purchased. Towels will not be supplied so please have a towel for your child as well. All other equipment will be supplied by The Swim School.</dd>
                ...
                <dd>In the event of inclement weather (i.e. thunder/lightning, heavy rain, and/or air temperature of 65 degrees or below), swim practices will be cancelled. River Wilderness Country Club has a lightning detection system with a siren. The coaches will remove all swimmers from the pool and relocate under the covered portion of the Fitness Center Facility immediately upon hearing the siren. The coach will contact you when a practice needs to be cancelled due to inclement weather. It is best to assume swim practices are on as scheduled if you are not contacted by the coach.</dd>

                <dt>No Makeup Practices:</dt>
                <dd>Swim practices will not be made up under any circumstances, including for inclement weather. The North River Swim Team program is an 18 week program and fees are based on 16 weeks to accommodate for swim practice cancellations due to inclement weather as well as any major nationally celebrated holidays (i.e. Memorial Day, Independence Day, etc.)</dd>
                ...
                <dt>End Of Season:</dt>
                <dd>At the conclusion of the swim team season, each swimmer will be recognized at an awards banquet to honor their achievements.</dd>
