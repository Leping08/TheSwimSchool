        ...
        <div class="uk-container">
            @if(config('season.groups.off-season'))
                <div class="uk-alert-primary" uk-alert>
                    ...
                    <p>Group lesson registration opens {{config('season.groups.next_season.registration_open')}}. For the full schedule, check out the <a href="/lessons/schedule">2019 group lesson schedule</a>.</p>
                </div>
            @endif
